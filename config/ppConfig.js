...
// Passport "serializes" objects to make them easy to store, conversting the user to an identified (id)
...
const findAndLogInUser = (email, password, doneCallback) => { // database call ! 
    db.user.findOne({where:{email:email}})
